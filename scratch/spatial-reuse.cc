...
//         packetCopy->RemoveHeader (subHdr);
//         extractedLength = subHdr.GetLength ();
//         packetCopy = packetCopy->CreateFragment (0, static_cast<uint32_t> (extractedLength));
      ...
      if (i < (n + 1)) // BSS 1
        {
          ...
          stmp << "/NodeList/" << i << "/DeviceList/*/$ns3::WifiNetDevice/Mac/BK_MaxAmpduSize";
          Config::Set (stmp.str(), UintegerValue (std::min(maxAmpduSizeBss1, 4194303u)));
          stmp << "/NodeList/" << i << "/DeviceList/*/$ns3::WifiNetDevice/Mac/VO_MaxAmpduSize";
          Config::Set (stmp.str(), UintegerValue (std::min(maxAmpduSizeBss1, 4194303u)));
          stmp << "/NodeList/" << i << "/DeviceList/*/$ns3::WifiNetDevice/Mac/VI_MaxAmpduSize";
          Config::Set (stmp.str(), UintegerValue (std::min(maxAmpduSizeBss1, 4194303u)));
        }
